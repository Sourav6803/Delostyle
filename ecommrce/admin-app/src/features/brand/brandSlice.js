...
export const getABrand = createAsyncThunk('brand/get-brand', async (id, thunkAPI) => {
    ...
    try {
        return await brandSrvice.getBrand(id);
    }
    catch (error) {
        return thunkAPI.rejectWithValue(error)
    }
...
export const createBrand  = createAsyncThunk('brand/create-brand', async (brandData, thunkAPI) => {
    ...
    try {
        return await brandSrvice.createBrand(brandData);
    }
    catch (error) {
        return thunkAPI.rejectWithValue(error)
    }
...
export const updateABrand  = createAsyncThunk('brand/update-brand', async (brand, thunkAPI) => {
    try {
        return await brandSrvice.updateBrand(brand)
    }
    catch (error) {
        return thunkAPI.rejectWithValue(error)
    }
...
export const deleteABrand  = createAsyncThunk('brand/delete-brand', async (brand, thunkAPI) => {
    try {
        return await brandSrvice.deleteBrand(brand)
    }
    catch (error) {
        return thunkAPI.rejectWithValue(error)
    }
